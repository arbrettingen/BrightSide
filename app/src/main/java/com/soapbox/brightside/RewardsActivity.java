...
public class RewardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDrawerList = (ListView) findViewById(R.id.rewards_left_drawer);
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.rewards_drawer_layout);

        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.string.drawer_open, R.string.drawer_close_rewards){
            @Override
    ...
    private void selectItemDrawer(int position) {
        ...
        mDrawerLayout.closeDrawer(findViewById(R.id.rewards_drawer_cont));
