...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.string.drawer_open, R.string.drawer_close_settings){
            @Override
    ...
    private void selectItemDrawer(int position) {
        ...
        mDrawerLayout.closeDrawer(findViewById(R.id.settings_drawer_cont));
